...
This project uses **bd** (beads) for issue tracking. User setup happens through `/onboard`; agents can run `bd onboard` only when they need the latest Beads instruction snippet.
